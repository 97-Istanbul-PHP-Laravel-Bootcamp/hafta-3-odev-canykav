...
<div class="card">
    <div class="card-content">
        <div class="card-body">
            <form class="form form-horizontal" method="POST" action="{{route('sale.store')}}">
                @csrf
                <div class="form-body">
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8 form-group">
                            <input type="text" class="form-control" name="orid" placeholder="Sipariş Numarası">
                        </div>
                        <div class="col-md-4">
                            <label>Satış Numarası</label>
                        </div>
                        <div class="col-md-8 form-group">
                            <input type="text" class="form-control" name="code" placeholder="Satış Numarası">
                        </div>
                        <div class="col-md-4">
                            <label>Fiyat</label>
                        </div>
                        ...
                        <div class="col-md-8 form-group">
                            <input type="date" class="form-control" name="sale_date" placeholder="Soyadı">
                        </div>
